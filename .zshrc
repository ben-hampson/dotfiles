...
alias update="sudo dnf update -y && sudo dnf upgrade -y && sudo dnf autoremove -y && flatpak -y update && brew upgrade && brew cleanup && gnome-software --autoupdate --interaction=none --mode=updates"
